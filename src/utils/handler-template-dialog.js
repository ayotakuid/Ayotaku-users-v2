...
export const Tailwind = {
  dialog: {
      ...
      header: {
          className: classNames('flex items-center justify-between shrink-0', 'bg-white text-gray-800 border-t-0  rounded-tl-lg rounded-tr-lg p-6', 'dark:bg-ayotaku-super-dark  dark:text-white/80')
      },
      ...
      content: ({ state }) => ({
          className: classNames('overflow-y-auto', 'bg-white text-gray-700 px-6 pb-8 pt-0', 'rounded-bl-lg rounded-br-lg', 'dark:bg-ayotaku-super-dark  dark:text-white/80 ', {
              grow: state.maximized
          })
      }),
      footer: {
          className: classNames('shrink-0 ', 'border-t-0 bg-white text-gray-700 px-6 pb-6 text-right rounded-b-lg', 'dark:bg-ayotaku-super-dark  dark:text-white/80')
      },
      mask: ({ state }) => ({
